      ...
      <div className="container px-lg-5"> 
        ...
        <div className="row gy-5">
          <div className="col-lg-7 col-xl-8 text-center text-lg-start">
            <h2 className="text-7 fw-600 mb-3">I'm <span className="text-primary">Simone Olivia,</span> a Web Developer</h2>
          ...
          <div className="col-lg-5 col-xl-4">
            <div className="ps-lg-4">
              <ul className="list-style-2">
                <li className=""><span className="fw-600 me-2">Name:</span>Simone Olivia</li>
                <li className=""><span className="fw-600 me-2">Email:</span><a href="mailto:chat@simone.com">chat@simone.com</a></li>
                <li className=""><span className="fw-600 me-2">Age:</span>28</li>
                <li className="border-0"><span className="fw-600 me-2">From:</span>Los Angeles, California</li>
              </ul>
        ...
        <div className="brands-grid separator-border mt-5">
          <div className="row">
            ...
            <div className="col-6 col-md-3">
             <Counter name="Years Experience" value="10" sign="+"></Counter>
            </div>

            <div className="col-6 col-md-3">
              <Counter name="Happy Clients" value="250" sign="+"></Counter>
            </div>

            <div className="col-6 col-md-3">
              <Counter name="Projects Done" value="650" sign="+"></Counter>
            </div>

            <div className="col-6 col-md-3">
              <Counter name="Get Awards" value="20" sign=""></Counter>
            </div>
          </div>
        </div>
      </div>
